...
//===========pin_picture=========
// void Line::init_pinpic()
// {
//   nIn_framenum = 0;
//   nOut_framenum = 0;
//   InputYuvStreamFile = NULL;
//   InputAviStreamFile = NULL;
//   InputMjpegStreamFile = NULL; 
//   pFramesBuffer = NULL;
//   pFrame_decoded = NULL;
// 
// }
// void Line::des_pinpic()
// {
//   if(InputYuvStreamFile)
//   {
//     delete InputYuvStreamFile;
//     InputYuvStreamFile = NULL;
//   }
//   if(InputAviStreamFile)
//   {
//     delete InputAviStreamFile;
//     InputAviStreamFile = NULL;
//   }
//   if(InputMjpegStreamFile)
//   {
//     delete InputMjpegStreamFile;
//     InputMjpegStreamFile = NULL;
//   }
// }
// void Line::OpenFile(CClientDC &dc)
// {
//   TCHAR szFilters[]= _T("JPEG/MJPEG (*.jpg/*.jpeg/*.mjpeg)|*.jpg;*.jpeg;*.mjpeg|Avi Files (*.avi)|*.avi|All Files (*.*)|*.*||");
//   CFileDialog fileDlg(TRUE, NULL, TEXT("*.avi"), OFN_FILEMUSTEXIST | OFN_HIDEREADONLY, szFilters);
//   if(fileDlg.DoModal()==IDOK)
//   {
//       pathName = (CStringA)fileDlg.GetPathName();
//       fileName = (CStringA)fileDlg.GetFileTitle();
//       fileType = (CStringA)pathName.Right(4);
// //     dc.TextOut(900,100,(CString)pathName);
//     if (fileType == ".avi"||fileType == ".AVI")
//     {
//       CAviStreamFile* pAviStream_temp = new CAviStreamFile( (char*)pathName.GetString(), FILETYPE_READ, 352, 288 );
//       InputAviStreamFile = pAviStream_temp;
//       pFrame_decoded = new CFrameContainer(InputAviStreamFile->getWidth(), InputAviStreamFile->getHeight(), YUVTYPE_444);
//       InputAviStreamFile->readFrame( pFrame_decoded, 0 );//nIn_framenum
//     }
//     if (fileType == "jpeg"||fileType == "JPEG")
//     {
//       CMjpegStreamFile* pMjpegStream_temp = new CMjpegStreamFile( (char*)pathName.GetString(), FILETYPE_READ, 720, 480 );
//       InputMjpegStreamFile = pMjpegStream_temp;
//       pFrame_decoded = new CFrameContainer(InputMjpegStreamFile->getWidth(), InputMjpegStreamFile->getHeight(), YUVTYPE_444);
//       InputMjpegStreamFile->readFrame( pFrame_decoded, 10 );//nIn_framenum
//     }
// 
//     return;
//   }
...
// }
// void Line::ShowVideo(CClientDC &dc)
// {
//   MSG msg;
//   flag5 = TRUE;
//   if (fileType == "jpeg"||fileType == "JPEG")
...
//     do
//     {
//       InputMjpegStreamFile->readFrame( pFrame_decoded, nIn_framenum);//nIn_framenum
//       pFrame_decoded->cvtRGB24toYUV444();
//       DrawBmptoPicture( dc, pFrame_decoded );
//       nIn_framenum++;
...
//     do
//     {
//       InputAviStreamFile->readFrame( pFrame_decoded, nIn_framenum );//nIn_framenum
//       pFrame_decoded->cvtRGB24toYUV444();
//       DrawBmptoPicture( dc, pFrame_decoded );
//       nIn_framenum++;
//       if(PeekMessage(&msg,0,0,0,PM_REMOVE))//
...
//   return;
// }
// void Line::DrawBmptoPicture( CClientDC &dc,CFrameContainer* pFrame_in  )
// {
//   int Width = pFrame_in->getWidth(),Height = pFrame_in->getHeight();
//   pFrame_in->cvtYUV444toRGB24();
//   DrawPicture1(dc,0,0,pFrame_in->m_BmpBuffer,Width,Height);
// }
//====================================
